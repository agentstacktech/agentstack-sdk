/**
 * ProfileComponent - Example React component using AgentStack SDK
 * Demonstrates how to use useAuth, useProfile, and useSettings hooks
 */

import React, { useState } from 'react';
import { useAuth, useProfile, useSettings } from '../index';

export function ProfileComponent() {
  const { user, isAuthenticated, isLoading: authLoading, login, logout } = useAuth();
  const { profileData, isLoading: profileLoading, updateProfile, setUsername, setDisplayName } = useProfile();
  const { settings, isLoading: settingsLoading, setTheme, setNotification } = useSettings();
