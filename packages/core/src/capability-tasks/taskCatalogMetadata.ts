...
export const TASK_CATALOG_METADATA: readonly TaskCatalogEntry[] = [
  ...
  { taskId: 'integrate.select_events', domain: 'integrations.connection', comfortBudget: 2, executionMode: 'split', shells: ['dev', 'user'] },
  { taskId: 'agents.automate_bind', domain: 'agents.agent', comfortBudget: 2, executionMode: 'inline', shells: ['dev', 'user'] },
  ...
  { taskId: 'crm.create_company', domain: 'crm.company', comfortBudget: 2, executionMode: 'inline', shells: ['dev', 'user'] },
  ...
  { taskId: 'commerce.surfaces.open_gallery', domain: 'commerce.storefront', comfortBudget: 2, executionMode: 'immersive', shells: ['user', 'dev'] },
  { taskId: 'commerce.embed.copy_buy_button', domain: 'commerce.storefront', comfortBudget: 2, executionMode: 'immersive', shells: ['user', 'dev'] },
  { taskId: 'commerce.lite.open_demo_store', domain: 'commerce.storefront', comfortBudget: 2, executionMode: 'immersive', shells: ['user', 'dev'] },
  ...
  { taskId: 'auth.create_agent_key', domain: 'auth.credentials', comfortBudget: 2, executionMode: 'inline', shells: ['dev', 'user'] },
  ...
  { taskId: 'operator.check_ecs_denorm', domain: 'operator.scale', comfortBudget: 2, executionMode: 'inline', shells: ['dev'] },
  { taskId: 'operator.review_bot_channels', domain: 'operator.fleet', comfortBudget: 2, executionMode: 'inline', shells: ['dev'] },
  { taskId: 'operator.open_attention_inbox', domain: 'operator.overview', comfortBudget: 2, executionMode: 'inline', shells: ['dev'] },
  { taskId: 'operator.review_fleet_runs', domain: 'operator.fleet', comfortBudget: 2, executionMode: 'inline', shells: ['dev'] },
  { taskId: 'operator.review_grant_readiness', domain: 'operator.grants', comfortBudget: 2, executionMode: 'inline', shells: ['dev'] },
  { taskId: 'operator.review_scale_gates', domain: 'operator.scale', comfortBudget: 2, executionMode: 'inline', shells: ['dev'] },
  { taskId: 'operator.scale_neurocache_slo', domain: 'operator.scale', comfortBudget: 2, executionMode: 'inline', shells: ['dev'] },
  { taskId: 'finance.top_up_card', domain: 'finance.payments', comfortBudget: 2, executionMode: 'split', shells: ['user', 'dev'] },
];
