...
| `docs/SDK_DOCS_I18N_ROADMAP.md` | `docs/SDK_DOCS_I18N_ROADMAP_ru.md` | paired | 40/41 | 0.98 | balanced |
...
| `packages/core/README.en.md` | `packages/core/README.md` | paired | 1090/1026 | 1.06 | legacy-ru-path |
| `packages/react/README.en.md` | `packages/react/README.md` | paired | 656/666 | 0.98 | legacy-ru-path |
| `packages/python/README.en.md` | `packages/python/README.md` | paired | 271/272 | 1 | legacy-ru-path |
| `packages/hooks/README.en.md` | `packages/hooks/README.md` | paired | 289/295 | 0.98 | legacy-ru-path |
| `docs/MODULAR_ARCHITECTURE.md` | `docs/MODULAR_ARCHITECTURE_ru.md` | paired | 309/330 | 0.94 | balanced |
| `docs/PROTEIN_SYSTEM_GUIDE.md` | `docs/PROTEIN_SYSTEM_GUIDE_ru.md` | paired | 493/494 | 1 | balanced |
