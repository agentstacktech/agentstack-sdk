...
Generated: 2026-05-30T02:41:17.905Z · `npm run generate:docs-i18n`

| EN | RU | Role | Lines EN/RU | Ratio | Status |
|----|-----|------|-------------|-------|--------|
| `README.en.md` | `README.md` | paired | 539/704 | 0.77 | legacy-ru-path |
...
| `packages/core/README.en.md` | `packages/core/README.md` | paired | 339/1106 | 0.31 | legacy-ru-path |
| `packages/react/README.en.md` | `packages/react/README.md` | paired | 302/666 | 0.45 | legacy-ru-path |
| `packages/python/README.en.md` | `packages/python/README.md` | paired | 93/269 | 0.35 | legacy-ru-path |
| `packages/hooks/README.en.md` | `packages/hooks/README.md` | paired | 156/295 | 0.53 | legacy-ru-path |
| `docs/MODULAR_ARCHITECTURE.md` | `docs/MODULAR_ARCHITECTURE_ru.md` | paired | 220/328 | 0.67 | balanced |
